...
put file://~/Desktop/data/empData.csv @stage_int;
...
CREATE OR REPLACE STORAGE INTEGRATION my_intS3
  ...
  STORAGE_ALLOWED_LOCATIONS = ('s3://mybucket4563/');
...
CREATE OR REPLACE STAGE ext_stage
  ...
  URL = 's3://mybucket4563/empData.csv'
...
put file://~/Desktop/data/cities.parquet @my_parquet_file_stage;
